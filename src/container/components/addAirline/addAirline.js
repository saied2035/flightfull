...
const AddAirline = () => {
  ...
  return (
    <section className="max-w-full relative font-['Repo'] flex-auto flex flex-col items-center bg-[#96bf01] gap-y-3">
      ...
      <form className="max-w-full flex-auto gap-y-3 w-full flex flex-col items-center">
        <Outlet />
      </form>
      {steps.nextStep < 3 && (
      <Link
        ...
        className={`${steps.currentStep === 4 ? 'pointer-events-none' : 'pointer-events-auto'} flex mt-5 font-medium text-[#97bf0e] bg-white px-3 py-2 rounded-full absolute sm:bottom-4 sm:right-4 bottom-[-4px] right-[-1rem] sm:scale-100 2xl:scale-125 scale-[0.6]`}
      >
        Next
        {' '}
      ...
      <Link
        ...
        className={`${steps.currentStep === 1 ? 'pointer-events-none' : 'pointer-events-auto'} flex mt-5 font-medium text-[#97bf0e] bg-white px-3 py-2 rounded-full absolute sm:bottom-4 sm:left-4 bottom-[-4px] left-[-1.2rem] sm:scale-100 2xl:scale-125 scale-[0.6]`}
      >
